...
Under frameworks like the GDPR[[4]](https://www.usenix.org/system/files/usenixsecurity24-bielova.pdf), consent must be “freely given, specific, informed, and unambiguous.” On paper, this sets a high bar. In practice, however, empirical evidence shows that the design of consent banners can systematically distort user choice, even when formal requirements are met.
...
Even robust regulatory frameworks face structural limitations. Scholars such as Woodrow Hartzog and Neil Richards[[5]](https://openscholarship.wustl.edu/cgi/viewcontent.cgi?article=6460&context=law_lawreview) argue that data protection law alone cannot resolve deeper power imbalances embedded in the digital economy.
